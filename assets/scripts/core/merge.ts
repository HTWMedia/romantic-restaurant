...
export const MERGE_ITEMS: MergeItem[] = [
  ...
  { id: 'm-pizza',  name: '披萨',   glyph: '🍕', artKey: 'dish-pizza', tier: 2, nextId: null, unlocksDishId: 'pizza' },
  // 链 B → steak
  { id: 'm-meat',   name: '生肉',   glyph: '🥩', tier: 0, nextId: 'm-stew' },
  { id: 'm-stew',   name: '炖肉',   glyph: '🍲', tier: 1, nextId: 'm-steak' },
  { id: 'm-steak',  name: '牛排',   glyph: '🥩', artKey: 'dish-steak', tier: 2, nextId: null, unlocksDishId: 'steak' },
  // 链 C → dessert
  { id: 'm-dough',  name: '面团',   glyph: '🍞', tier: 0, nextId: 'm-cake' },
  { id: 'm-cake',   name: '蛋糕胚', glyph: '🍰', tier: 1, nextId: 'm-dessert' },
  { id: 'm-dessert',name: '甜品',   glyph: '🍰', artKey: 'dish-dessert', tier: 2, nextId: null, unlocksDishId: 'dessert' },
  // 链 D → pasta
  { id: 'm-cheese', name: '奶酪',   glyph: '🧀', tier: 0, nextId: 'm-pastadough' },
  { id: 'm-pastadough', name: '面坯', glyph: '🥟', tier: 1, nextId: 'm-pasta' },
  { id: 'm-pasta',  name: '意面',   glyph: '🍝', artKey: 'dish-pasta', tier: 2, nextId: null, unlocksDishId: 'pasta' },
];
